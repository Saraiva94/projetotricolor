...
function getInfoBasedOnScore(){
    if(totalScore() < 6){
        var score_info = "Se você for tricolor de coração, precisa conhecer mais seu clube, ao contrário disso está perdoado!";
    } else if(totalScore() > 6){
        var score_info = "Parabéns, você é um integrante da torcida tricolor, Clube de Guerreiros, está em dia com os conhecimentos de um torcedor!"
    }
